...
class ExchangeCapsule extends StatelessWidget {
  ExchangeCapsule({super.key});
      ...
      body: Stack(children: [
        ...
        Column(
          children: [
            ...
            ListView(
              children: [
                const Text("Exchange TSPOT (Testnet)",
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Image(
                        image: AssetImage('assets/img/concept_WIP.png'),
                      ),
                      SimpleTextfield(_controller,
                          hint: "Amount of TSPOT to exchange"),
                      Column(
                        children: [
                          ConstrainedBox(
